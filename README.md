...
[![Get WordHaze from Microsoft Store](https://img.shields.io/badge/Microsoft_Store-Install_WordHaze-blue?style=for-the-badge&logo=microsoft)](https://apps.microsoft.com/detail/9NG1T2K7BLJS?hl=en-us&gl=US)

![WordHaze Microsoft Store Listing](images/wordhaze-store-main-user.png)
...
*   ![Microsoft Store listing for WordHaze](images/wordhaze-store-main-user.png)

### BetaNews
*   **Label:** BetaNews
*   **Details:** WordHaze was included in a Windows app roundup.
*   ![BetaNews reference for WordHaze](images/wordhaze-betanews-user.png)

### Software Discussion
*   **Label:** Community mention
*   **Details:** WordHaze appears in a discussion about offline Windows word-cloud software.
*   ![Community mention for WordHaze](images/wordhaze-babia-user.png)
